...
class explosion_particles_class:
    def __init__(self,color,location):
        ...
        self.rect=pygame.Rect(self.location[0],self.location[1],self.breadth,self.length)
    ...
    def draw(self,SCREEN):
        pygame.draw.rect(SCREEN,self.color,[self.rect[0],self.rect[1],self.length,self.breadth])
    ...
    def move(self,scroll):
        ...
        self.length-=0.1
        self.breadth-=0.1
        self.rect=pygame.Rect(self.rect[0],self.rect[1],self.breadth,self.length)
...
class lava_class:
    ...
    def check_move(self,rects,moving_rects):
        self.lava_rect=pygame.Rect(self.center[0]-self.radius,self.center[1]-self.radius,2*self.radius,2*self.radius)
...
class player_health_bar:
    def __init__(self):
        ...
        self.list=[(100,25),(125,25),(150,25),(175,25),(200,25),(225,25),(250,25),(275,25),(300,25),(325,25),(350,25),(375,25),(400,25),(425,25),(450,25),(475,25),(500,25),(525,25),(550,25),(575,25)]
        self.height=25
        self.width=500
        self.target_list=[]
        self.hit=False
    ...
    def draw(self,SCREEN,player):
        ...
        if self.width>0:     
            pygame.draw.rect(SCREEN,self.color,[100,25,self.width,self.height])
...
class enemy_health_bar:
    ...
    def draw(self,SCREEN):
        pygame.draw.rect(SCREEN,self.color,[self.location[0],self.location[1],self.dimension[0],self.dimension[1]])
...
class child_health_bar:
    def __init__(self):
        ...
        self.dimension=[25,25]
        self.list=[(600,25),(625,25),(650,25),(675,25),(700,25),(725,25),(750,25),(775,25),(800,25),(825,25),(850,25),(875,25),(900,25),(925,25),(950,25),(975,25),(1000,25),(1025,25),(1050,25),(1075,25)]
        self.height=25
        self.width=500
        self.target_list=[]
        self.hit=False
    ...
    def draw(self,SCREEN,child):
        ...
        if self.width>0:     
            pygame.draw.rect(SCREEN,self.color,[600,25,self.width,self.height])
...
class stick_timer:
    ...
    def draw(self,SCREEN,player,child):
        ...
        if self.combined_dimension[0]>0:
            pygame.draw.rect(SCREEN,self.color,[self.location[0],self.location[1],self.combined_dimension[0],self.combined_dimension[1]])
        if player.stick:
...
class impact_particles_class:
    def __init__(self,bullet_loc,player_loc,color):
        ...
        self.angle=random.uniform(math.atan2(bullet_loc[1]-player_loc[1],bullet_loc[0]-player_loc[0])-0.785,math.atan2(bullet_loc[1]-player_loc[1],bullet_loc[0]-player_loc[0])+0.785)
...
class shockwave_class:
    ...
    def draw(self,SCREEN):
        pygame.draw.circle(SCREEN,self.color,[int(self.center[0]),int(self.center[1])],self.radius,int(self.width))
...
class afterwave_class:
    def __init__(self,loc,color):
        ...
        self.radius=20
        self.width=9
        self.center=[loc[0]+random.choice([random.randint(-20,-10),random.randint(10,20)]),loc[1]+random.choice([random.randint(-20,-10),random.randint(10,20)])]
